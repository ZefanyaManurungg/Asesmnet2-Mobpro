        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.tambah_penghuni),
                    tint = putih
                )
            }
        }
...
@Composable
fun ListItem(mahasiswa: Penghuni, onClick: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
        ...
        Text(text = mahasiswa.nokamar,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis
        )
        Text(text = mahasiswa.lantai)
    }
}

@Composable
fun GridItem(mahasiswa: Penghuni, onClick: () -> Unit) {
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
